...
<html>
    ...
    <body>
        ...
        <div class="format_area">
            <h1 class="container-fluid text-center">Amortização americana</h1><br><br>
            </hr>
            ...
            <% if(request.getParameter("btnCalc")!= null){ %>
                <div class="container-fluid format_tabela"><% DecimalFormat dv = new DecimalFormat("#,##0.00");out.print("Valor da Prestação R$ "+ dv.format(gg.CalcPrestAmeric(pv, n, i)));%></div>
